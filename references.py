...
############################################################
# agentic rl
previous_share_on_rl = Reference(title="强化学习简单综述", organization="ata", authors=["Dong Lyu"], date="2025", url="https://ata.atatech.org/articles/12020396838")
agentic_rl_landscape = arxiv_reference("https://arxiv.org/pdf/2509.02547", notes=join(
    "Agentic Reinforcement survey"
))
qwen_tool_call = Reference(title="Function Calling", organization="Alibaba", url="https://qwen.readthedocs.io/en/latest/framework/function_call.html")
rstar_agent = arxiv_reference("https://arxiv.org/pdf/2508.20722", organization="Microsoft", notes=(
    "Python tool calling, code interpreter as environment"
))
