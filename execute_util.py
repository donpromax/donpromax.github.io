...
def text(message: str, style: dict | None = None, rendering_type: str = "markdown", verbatim: bool = False):
    ...
    for message in messages:
        _current_renderings.append(Rendering(type=rendering_type, data=message, style=style))


def image(url: str, style: dict | None = None, width: int | str | None = None, center: bool = False):
